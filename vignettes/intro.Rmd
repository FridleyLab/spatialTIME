...
values = getColors(length(mnames_bad))
...
```{r}
grid.arrange(bad_names, good_names, ncol=2)
```
...
values = getColors(length(unique(x$derived$univariate_Count$deidentified_sample)))
