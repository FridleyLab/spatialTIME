...
x <- ripleys_k2(mif = x, mnames = mnames_good, 
               ...
               edge_correction = 'translation', r = 0:100,
               permute = TRUE,
...
values = RColorBrewer::brewer.pal(length(unique(x$derived$univariate_Count$Label)), "Accent")
...
x$derived$univariate_Count  %>%
  ...
  geom_line(aes(color = Label), show.legend = FALSE) +
