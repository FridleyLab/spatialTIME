...
x[["derived"]][["ripleys"]] <- ripleys_k(mif = x, id = "image_tag", mnames = mnames[1], num_permutations = 1,
...
x[["derived"]][["bi-ripleys"]] <- bi_ripleys_k(mif = x, id = "image_tag", mnames = mnames_pairs, num_permutations = 1,
