...
Once the degree of spatial clustering has be computed questions like "Is the degree of clustering for CD3+ cells between two populations different? (t-test) or "Is the pattern of degree of clustering different between two populations?" (can be checked visually with a heatmap).
