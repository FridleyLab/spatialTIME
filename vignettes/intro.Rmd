...
x <- ripleys_k2(mif = x, mnames = mnames_good, 
...
```{r,fig.width=10, fig.height=6, fig.align = 'center'}
x <- bi_ripleys_k2(mif = x, mnames = c("CD3..CD8.", "CD3..FOXP3."), 
                  num_permutations = 10, 
                  edge_correction = 'translation', r_range = 0:100,
...
The interpretation of the degree of clustering is the same here. The green line shows evidence that Tregs tend to cluster around Cytotoxic T cells for all values of $r$, while the black line indicates spatial repulsion of Tregs by Cytotoxic T cells for $\gt50$. 
...
x <- NN_G2(mif = x, mnames = mnames_good, num_permutations = 10,
                edge_correction = 'rs', r = 0:100,
                keep_permutation_distribution = FALSE, workers = 1)
